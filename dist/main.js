...
},{"./../utilities/apiUrl":10,"backbone":29,"jquery":30,"underscore":31}],2:[function(require,module,exports){
var Backbone = require('backbone'),
		_ = require('underscore'),
		$ = require('jquery'),
		API_URL = require('./../utilities/apiUrl'),
...
},{"./../models/Arrival":6,"./../utilities/apiUrl":10,"backbone":29,"jquery":30,"underscore":31}],3:[function(require,module,exports){
var Backbone = require('backbone'),
		_ = require('underscore'),
		$ = require('jquery'),
		API_URL = require('./../utilities/apiUrl');
...
},{"./../utilities/apiUrl":10,"backbone":29,"jquery":30,"underscore":31}],4:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"./../utilities/apiUrl":10,"backbone":29}],5:[function(require,module,exports){
var Backbone = require('backbone'),
		_ = require('underscore'),
		$ = require('jquery');
...
},{"./utilities/dateUtils":12,"./utilities/router":14,"backbone":29,"jquery":30,"underscore":31}],6:[function(require,module,exports){
var Backbone = require('backbone'),
		_ = require('underscore'),
		$ = require('jquery');
...
},{"backbone":29,"jquery":30,"underscore":31}],7:[function(require,module,exports){
var Backbone = require('backbone'),
		_ = require('underscore'),
		$ = require('jquery');
...
},{"backbone":29,"jquery":30,"underscore":31}],8:[function(require,module,exports){
module.exports = function() {
    return new google.maps.LatLng(36.863794,-76.285608);
}
...
},{"./../utilities/DowntownNorfolk":8}],10:[function(require,module,exports){
module.exports = function() {
...
},{"backbone":29,"jquery":30}],12:[function(require,module,exports){
module.exports = function() {
...
},{"./../utilities/contentView":11,"./../views/FindStopsView":16,"./../views/HomeView":17,"./../views/RouteView":19,"./../views/SnowRoute":20,"./../views/StopsByIdView":23,"./intervalService.js":13,"backbone":29,"jquery":30,"underscore":31}],15:[function(require,module,exports){
var Backbone = require('backbone'),
		_ = require('underscore'),
		$ = require('jquery'),
...
},{"./../utilities/intervalService":13,"./../views/MapView":18,"./../views/templates/Arrival.tpl.html":24,"backbone":29,"jquery":30,"underscore":31}],16:[function(require,module,exports){
var Backbone = require('backbone'),
		_ = require('underscore'),
		$ = require('jquery'),
...
module.exports = Backbone.View.extend({
  ...
  template: FindStopsViewTemplate,
...
},{"./../models/Stop":7,"./../utilities/apiUrl":10,"./../utilities/contentView":11,"./../utilities/router":14,"./../views/MapView":18,"./templates/FindStopsView.tpl.html":25,"backbone":29,"jquery":30,"underscore":31}],17:[function(require,module,exports){
var Backbone = require('backbone'),
		_ = require('underscore'),
		$ = require('jquery'),
...
},{"./../collections/StopList":4,"./../utilities/LocateUser":9,"./../views/StopListView":21,"./templates/StopList.tpl.html":28,"backbone":29,"jquery":30,"underscore":31}],18:[function(require,module,exports){
var Backbone = require('backbone'),
		_ = require('underscore'),
		$ = require('jquery');
...
},{"backbone":29,"jquery":30,"underscore":31}],19:[function(require,module,exports){
var Backbone = require('backbone'),
		_ = require('underscore'),
		$ = require('jquery'),
...
},{"./../collections/ActiveRoutesList":1,"./../collections/BusList":3,"./../utilities/DowntownNorfolk":8,"./templates/RouteView.tpl.html":26,"backbone":29,"jquery":30,"underscore":31}],20:[function(require,module,exports){
var Backbone = require('backbone'),
		_ = require('underscore'),
		$ = require('jquery');
...
},{"backbone":29,"jquery":30,"underscore":31}],21:[function(require,module,exports){
var Backbone = require('backbone'),
		_ = require('underscore'),
		$ = require('jquery'),
...
},{"./../views/StopView":22,"backbone":29,"jquery":30,"underscore":31}],22:[function(require,module,exports){
var Backbone = require('backbone'),
		_ = require('underscore'),
		$ = require('jquery');
...
},{"./../collections/ArrivalList":2,"./../utilities/contentView":11,"./../utilities/intervalService":13,"./../views/ArrivalView":15,"./templates/Stop.tpl.html":27,"backbone":29,"jquery":30,"underscore":31}],23:[function(require,module,exports){
var Backbone = require('backbone'),
		_ = require('underscore'),
		$ = require('jquery');
...
},{"./../collections/StopList":4,"./../views/StopListView":21,"backbone":29,"jquery":30,"underscore":31}],24:[function(require,module,exports){
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="row-fluid">\r\n  <div class="span2 route quarter">'+
((__t=( routeId ))==null?'':__t)+
'</div>\r\n  <div class="span8 destination half">\r\n    <p>'+
((__t=( destination ))==null?'':__t)+
'</p>\r\n  </div>\r\n  <div class="span2 timeframe quarter">'+
((__t=( arriveMinutes ))==null?'':__t)+
'</div>\r\n</div>\r\n\r\n<div class="mapcanvas"></div>\r\n<div class="extended-info" style="display:none;">\r\n  <span>Location of <strong>Bus '+
((__t=( busId ))==null?'':__t)+
'</strong> as of <strong><span class=\'lastUpdate\'>'+
((__t=( lastUpdate ))==null?'':__t)+
'</span></strong>.</span>\r\n  <p class="arrival-time">Scheduled Arrival: <strong>'+
((__t=( arriveTime ))==null?'':__t)+
'</strong> - '+
((__t=( adherence ))==null?'':__t)+
...
__p+='\r\n    <option value="'+
((__t=( route.route_id ))==null?'':__t)+
'">'+
((__t=( route.route_short_name ))==null?'':__t)+
' - '+
((__t=( route.route_long_name ))==null?'':__t)+
'</option>\r\n  ';
 }); 
__p+='\r\n</select>\r\n<div class="mapcanvas"></div>\r\n';
}
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="stop-name"><h4>'+
((__t=( stopName ))==null?'':__t)+
'</h4> <p>(Stop '+
((__t=( stopId ))==null?'':__t)+
